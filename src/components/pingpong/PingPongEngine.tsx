...
export function PingPongEngine() {
      ...
      <ScrollView className="flex-1 p-4 bg-[#f2ece0] dark:bg-brand-bg">
        {!campeonatoIniciado ? (
          <View className="bg-[#e6ddca] dark:bg-brand-surface p-5 rounded-xl border border-[#d8ccb4] dark:border-brand-border-focus">
            <Text className="text-xl font-bold text-brand-primary dark:text-brand-electric-light mb-4 text-center">🏓 Configurar Times do Ping Pong</Text>
